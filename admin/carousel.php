                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="mb-3">
                                        ...
                                        <input type="file" class="form-control shadow-none" id="carousel_picture_inp" name="carousel_picture" accept="[.png, .jpg, .webp, .jpeg]" required>
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" onclick="carousel_picture.value=''" class="btn text-secondary shadow-none" data-bs-dismiss="modal">Close</button>
